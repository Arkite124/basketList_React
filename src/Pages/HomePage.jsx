...
export const categoryClassName={
    "alcohols":"bg-amber-300 m-3 h-[20rem] max-h-[30rem] min-h-[15rem] w-[20rem] max-w-[30rem] min-w-[15rem] rounded-2xl",
    "stationery":"bg-rose-300 m-3 h-[20rem] max-h-[30rem] min-h-[15rem] w-[20rem] max-w-[30rem] min-w-[15rem] rounded-2xl",
    "snacks":"bg-indigo-300 m-3 h-[20rem] max-h-[30rem] min-h-[15rem] w-[20rem] max-w-[30rem] min-w-[15rem] rounded-2xl",
    "instantFood":"bg-fuchsia-300 m-3 h-[20rem] max-h-[30rem] min-h-[15rem] w-[20rem] max-w-[30rem] min-w-[15rem] rounded-2xl",
    "Fresh":"bg-green-300 m-3 h-[20rem] max-h-[30rem] min-h-[15rem] w-[20rem] max-w-[30rem] min-w-[15rem] rounded-2xl"
}
...
export default function HomePage(){
    ...
    return(
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-row w-full overflow-y-auto h-[1000px]">
               ...
               return (
                ...
                <div className="border-0 flex flex-col items-center justify-center w-full m-2 h-full">
                    ...
                    <div className="w-0.9 h-1/2 flex flex-col justify-center items-center">
                        ...
                        <span className="text-xl font-mono font-semibold text-indigo-900 my-0.5 block text-ellipsis whitespace-nowrap">판매자 : {product.users.userNickname}</span>
                    </div>
                </div>
                </div>
                )})}
            ...
            rounded-lg bg-pink-400/70 text-bold text-purple-700 text-4xl font-mono mt-5">장보러 가기</button></Link>
            <button type={"button"} className="border w-[30rem] h-[7.5rem] rounded-lg max-w-[75%]
            bg-pink-400/70 text-purple-700 text-4xl font-mono my-5">담긴 상품 구매 하기<br/>(추후 구현 예정)</button>
        </div>
    )
}