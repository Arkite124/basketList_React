...
export default function Loading({message}){
    return(
        <div className="my-[2rem] h-[8rem] w-[8rem] flex flex-col justify-center items-center rounded-[10000px]">
            <div className="inset-0 rounded-full bg-gradient-to-r from-red-500
            via-yellow-400 via-green-400 via-blue-400 to-purple-500 animate-spin w-[80%] h-[80%]"></div>
